...
if($op == 'delete'){
    $id = $_GET['id'];
    $sql1  = "delete from infoi where id = '$id'";
...
<table class="table table-striped">
    ...
    <tbody>
        ...
        $sql1  = "select * from infoi $sqltambahan ";
        ...
        while ($r1 = mysqli_fetch_array($q1)) {
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="info.php?op=delete&id=<?php echo $r1['id']?>" onclick="return confirm('Apakah anda yakin ingin menghapus data?')">
...
<nav aria-label="Page navigation example">
    <ul class="pagination">
        ...
        for($i=1; $i<= $pages; $i++){
            ?>
            <li class="page-item">
                <a class="page-link" href="info.php?latakunci=<?php echo $katakunci?>&cari=<?php echo $cari?>&page=<?php echo $i?>"><?php echo $i?></a>
            </li>
            <?php
        }
        ?>
