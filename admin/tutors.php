...
if($op == 'delete'){
    $id = $_GET['id'];
    $sql1 = "select foto from tutorsi where id = '$id'";
    $q1 = mysqli_query($koneksi,$sql1);
    $r1 = mysqli_fetch_array($q1);
    @unlink("../gambar/".$r1['foto']);

    $sql1  = "delete from tutorsi where id = '$id'";
    $q1    = mysqli_query($koneksi,$sql1);
    if($q1){
...
<table class="table table-striped">
    ...
    <tbody>
        ...
        $sql1  = "select * from tutorsi $sqltambahan ";
        ...
        while ($r1 = mysqli_fetch_array($q1)) {
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="tutors.php?op=delete&id=<?php echo $r1['id']?>" onclick="return confirm('Apakah anda yakin ingin menghapus data?')">
...
<nav aria-label="Page navigation example">
    <ul class="pagination">
        ...
        for($i=1; $i<= $pages; $i++){
            ?>
            <li class="page-item">
                <a class="page-link" href="tutors.php?latakunci=<?php echo $katakunci?>&cari=<?php echo $cari?>&page=<?php echo $i?>"><?php echo $i?></a>
            </li>
            <?php
        }
        ?>
