...
<head>
    ...
    <title>Programming Fauziah Ramadhani</title>
    <link rel="stylesheet" href="<?php  echo url_dasar()?>/css/style.css">
</head>
<body>
    <nav>
        <div class="wrapper">
            <div class="logo"><a href='<?php echo url_dasar()?>'>Class Online.</a></div>
            <div class="menu">
                <ul>
                    ...
                    <a href="pendaftaran.php" class="tbl-biru">Sign Up</a></li>
                    <?php } ?>
                </ul>
            </div>
        </div>
